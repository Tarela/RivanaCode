...
if __name__ == "__main__":
    ...
    try:
        ...
        parser.add_argument( '--cs', dest='chromesize',  type=str, required=False, default="/scratch/sh8tv/Data/Genome/hg38/chromInfo_hg38.txt", help='chrom.sizes is two columns: <chromosome name> <size in bases>' )
#        parser.add_argument( '--tss', dest='refseqTSS',  type=str, required=False, default="/scratch/sh8tv/Project/regulation_network/Data/annotation/hg38_uniq_symbol_withExonArrayExp_TSS.bed", help='refseqTSS is six columns: <chromosome name> <TSS> <TSS+1> <refseq:genesymbok> <score> <strand>' )
        parser.add_argument( '--tss', dest='refseqTSS',  type=str, required=False, default="/scratch/sh8tv/Data/refgenes/hg38/hg38_refseq_clean_tss_forRP.bed", help='refseqTSS is six columns: <chromosome name> <TSS> <TSS+1> <refseq:genesymbok> <score> <strand>' )
